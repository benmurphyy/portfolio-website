...
import SkillIcons from 'src/pages/knowledge/components/SkillsSection/SkillIcons';
import SkillsHeader from 'src/pages/knowledge/components/SkillsSection/SkillsHeader';
