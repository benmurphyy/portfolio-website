...
(self.webpackChunkmy_webpage_revamped =
  ...
  [810],
  {
    12: function (M, e, i) {
      ...
      var I,
        t = i.p + '32458e8ea01881dddaa6.jpg',
        g = i(7294),
        N = i(682),
        T = i(4051),
        n = i(1555),
        ...
        D = i(9603);
      !(function (M) {
        (M.CAREER_EXPERIENCE = 'Career Experience'),
          (M.ACHIEVEMENTS = 'Achievements'),
          (M.PROJECTS = 'Projects');
      })(I || (I = {}));
      var C = [I.CAREER_EXPERIENCE, I.ACHIEVEMENTS, I.PROJECTS],
        L = [
          {
            title: 'This Webpage',
      ...
      function l(M, e) {
        return (
          ...
          (function (M, e) {
            if (M) {
              if ('string' == typeof M) return A(M, e);
              var i = Object.prototype.toString.call(M).slice(8, -1);
              return (
                'Object' === i && M.constructor && (i = M.constructor.name),
                'Map' === i || 'Set' === i
                  ? Array.from(M)
                  : 'Arguments' === i ||
      ...
      function A(M, e) {
        (null == e || e > M.length) && (e = M.length);
        for (var i = 0, I = new Array(e); i < e; i++) I[i] = M[i];
        return I;
      }
      var z = (0, g.forwardRef)(function (M, e) {
        var i = l((0, g.useState)(80), 2),
          I = i[0],
          t = i[1],
          o = l((0, g.useState)(80), 2),
          a = o[0],
          j = o[1];
        function s() {
          window.innerWidth >= 992 ? (t(100), j(100)) : (t(80), j(80));
        }
        return (
          ...
          (0, y.jsxs)(N.Z, {
            ref: e,
            children: [
              (0, y.jsx)(D.Z, { title: 'Projects', isHiddenOnPhone: !0 }),
              (0, y.jsx)(T.Z, {
                className: 'justify-content-end pt-2',
                children: (0, y.jsxs)(n.Z, {
                  className: 'd-flex flex-column justify-content-center',
                  children: [
                    (0, y.jsx)('h2', { children: 'A Short Write-Up.' }),
                    (0, y.jsx)('hr', { className: 'mt-0 mb-2' }),
                    (0, y.jsx)('p', {
                      children:
                          ...
                          (0, y.jsxs)(r.Z.Body, {
                            children: [
                              ...
                              (0, y.jsx)('ul', {
                                ...
                                children: M.summary.map(function (M) {
                                  return (0, y.jsx)('li', { children: M }, M);
                                }),
                              }),
                              (0, y.jsx)('h5', { children: 'Description' }),
                              (0, y.jsx)(N.Z, {
                                className: 'w-25',
                                children: (0, y.jsx)('hr', {
                                  className:
      ...
      var u = z,
        ...
        d = (0, g.forwardRef)(function (M, e) {
          return (0, y.jsxs)(N.Z, {
            ref: e,
            children: [
              (0, y.jsx)(D.Z, { title: 'Achievements' }),
              (0, y.jsx)(N.Z, {
                children: (0, y.jsx)(T.Z, {
                  children: (0, y.jsx)(n.Z, {
                    children: (0, y.jsx)('ul', {
                      className: 'achievements-list',
                      children: w.map(function (M) {
                        return (0, y.jsx)('li', { children: M }, M);
                      }),
                    }),
                  }),
      ...
      d.displayName = 'AchievementSubPage';
      var E = d;
      function m(M, e) {
        (null == e || e > M.length) && (e = M.length);
        for (var i = 0, I = new Array(e); i < e; i++) I[i] = M[i];
        ...
        Q = (0, g.forwardRef)(function (M, e) {
          var i,
            ...
            t =
              ...
              (function (M) {
                ...
                (function (M, e) {
                  if (M) {
                    if ('string' == typeof M) return m(M, e);
                    var i = Object.prototype.toString.call(M).slice(8, -1);
                    return (
                      'Object' === i &&
                        M.constructor &&
                        (i = M.constructor.name),
                      'Map' === i || 'Set' === i
                        ? Array.from(M)
                        : 'Arguments' === i ||
                          /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i)
          ...
          return (
            ...
            (0, y.jsxs)(N.Z, {
              ref: e,
              children: [
                (0, y.jsx)(D.Z, { title: 'Career Experience' }),
                S.map(function (M) {
                  return (0, y.jsxs)(
                    N.Z,
                    {
      ...
      Q.displayName = 'CareerExperienceSubpage';
      var O = Q,
        h = i(267),
        k = x.K.G,
        p = x.K.R;
      function U(M) {
        var e = M.mainNavbarRef,
          i = (0, s.Z)(C),
          r = (0, g.useRef)(null);
        return (
          (0, j.Z)(r, e, i),
          (0, y.jsxs)(N.Z, {
            ...
            children: [
              ...
              (0, y.jsx)(O, { ref: i.current.get(I.CAREER_EXPERIENCE) }),
              (0, y.jsx)(E, { ref: i.current.get(I.ACHIEVEMENTS) }),
              (0, y.jsx)(u, { ref: i.current.get(I.PROJECTS) }),
            ],
          })
        );
      }
